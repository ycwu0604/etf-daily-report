...
@media (max-width: 768px) {
  body { padding: 0 .5em; }
  h1 { font-size: 1.3em; }
  .tabs { flex-wrap: wrap; gap: .3em; border-bottom: none; margin-bottom: .5em; }
  .tab-btn { font-size: .82em; padding: .4em .8em; border-bottom: 1px solid #ccc; border-radius: 4px; }
  .tab-btn.active { border-bottom-color: #4472C4; }
  .section { margin: 1em 0; }
  .pos-title, .neg-title { font-size: 1em; }
  .ta-table { font-size: .82em; }
  .ta-table th, .ta-table td { padding: .3em .4em; white-space: nowrap; }
  .ind { display: none; }  /* hide indicator details on mobile */
}
@media (max-width: 400px) {
  .tab-btn { font-size: .75em; padding: .3em .5em; }
  .ta-table { font-size: .78em; }
}
"""
...
def render_html(all_etf_data: dict, output_path: str):
    ...
    html.append(f'<p class="meta">{today}</p>')
